  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury: "bg-gradient-luxury text-primary-foreground hover:shadow-glow font-medium tracking-wide",
        gold: "bg-gradient-gold text-luxury-gold-foreground hover:shadow-glow font-medium tracking-wide border border-luxury-gold/20",
        hero: "bg-primary/90 backdrop-blur-sm text-primary-foreground hover:bg-primary border border-primary-foreground/20 font-semibold tracking-wide",
      },
      size: {
